				...
				<div class="image align-content-center">
					<div
						...
						<div class="col-md-12 text-center rounded p-3 bg-white box">
							<h3 style="font-weight: bold">Welcome to Odyssey</h3>
				...
				<div class="container mt-4 mb-5">
					...
					<div class="row mt-4 border p-3 rounded-3 vh-25 box-area">
						...
						<div class="col-md-4 pe-0 price">
							...
							<a href="" class="btn btn-success mt-3 ms-2" role="button"
								data-bs-toggle="button">Book now</a>
						</div>
					</div>
				</div>
	...
	<footer class="bg-dark text-center text-white">
		...
		<div class="container px-4 py-2 pb-0">
			...
			<section class="mb-2">
				...
				<!-- Twitter -->
				<a class="btn btn-outline-light btn-floating m-1" href="#!"
					role="button" style="border: none;"><i class="bi bi-twitter-x"></i></a>
				<!-- Google -->
				<a class="btn btn-outline-light btn-floating m-1" href="#!"
					role="button" style="border: none;"><i class="bi bi-google"></i></a>
				<!-- Instagram -->
				<a class="btn btn-outline-light btn-floating m-1" href="#!"
					role="button" style="border: none;"><i class="bi bi-instagram"></i></a>
				<!-- Linkedin -->
				<a class="btn btn-outline-light btn-floating m-1" href="#!"
				...
				<!-- Github -->
				<a class="btn btn-outline-light btn-floating m-1" href="#!"
					role="button" style="border: none;"><i class="bi bi-github"></i></a>
			</section>
			<!-- Section: Social media -->
		</div>
